<?php
/*
Template Name: Single Obras Infraestrutura Construtora
*/
include('header.php'); ?>
    ...
    <div class="container-fluid">
        <div class="container-banner">
            <div class="container-title-banner-dna">
                <h1>Aeroporto <br>&ensp;&ensp;de Aripuanã</h1>
            </div>
...
<section id="hospital-saude-con">
    <div class="container container-obra-saude-text">
        <h1>Aeroporto de Aripuanã</h1>
        <p>A ampliação e modernização do Aeroporto de Aripuanã foi a primeira obra no segmento de aeroportos realizada pela Maximo Aldana para mineradora Nexa Resources em parceria com a Prefeitura de Aripuanã. Fomos contratados na modalidade Design & Build para o desenvolvimento dos projetos visando atingir a viabilidade do empreendimento.
        </p>
        <p>O escopo da obra envolveu a construção de um novo terminal de embarque de passageiros, ampliação da pista, terraplanagem, cercamento de todo o perímetro e a instalação de balizamento noturno de acordo com as exigências da ANAC. </p>
        <p style="margin-bottom: 3rem;">Um dos principais benefícios do projeto é a possibilidade de resgate de pacientes durante 24 horas e proporcionar o crescimento do turismo e dos negócios, destacando o município na malha aérea do Mato Grosso.</p>
        <div id="carouselExampleIndicators" class="carousel slide">
            ...
            <div class="carousel-inner">
                <div class="carousel-item active">
                    <img src="./src/img/capa-Aeroporto-de-Aripuanã-Obra-Maximo-Aldana-496x366.png" class="d-block w-100" alt="...">
                </div>
            ...
            <div class="container-one-detalhes">
                <div>
                    <div class="content-text-detalhes">
                        ...
                        <h2 class="valor-detalhe-obra-saude">33.333 m²</h2>
                    </div>
                    <hr>
                </div>
                <div>
                    <div class="content-text-detalhes">
                        ...
                        <h2 class="valor-detalhe-obra-saude">Março de 2022</h2>
                    </div>
                    <hr>
                </div>
                <div>
                    <div class="content-text-detalhes">
                        <h2 class="name-detalhe-obra-saude">Arquitetura</h2>
                        <h2 class="valor-detalhe-obra-saude">Máximo Aldana</h2>
                    </div>
                    <hr>
                </div>
            </div>
            <div class="container-one-detalhes">
                <div>
                    <div class="content-text-detalhes">
                        ...
                        <h2 class="valor-detalhe-obra-saude">Aeroportos</h2>
                    </div>
                    <hr>
                </div>
                <div>
                    <div class="content-text-detalhes">
                        <h2 class="name-detalhe-obra-saude">Prazo da Obra</h2>
                        <h2 class="valor-detalhe-obra-saude">12 meses</h2>
                    </div>
                    <hr>
                </div>
...
<section id="acompanhe-obra-con">
    <div class="container">
        <div class="content-acampanhamento-obra">
            <h1>Confira a Obra</h1>
            <div class="content-img-acompanhamento-obra">
                <img src="./src/img/amarelo.png" alt="">
            </div>
        </div>
...
<section id="para-sua-fase">
    <div class="container-fluid px-5">
        <div class="container-title">
            <h3 class="container-title__title" style="text-align: center;">Conheça outros empreendimentos do mesmo segmento</h3>
            <h6 class="container-title__subtitle mb-0">Todos construídos pela Maximo Aldana</h6>
        </div>
            ...
            <div class="carousel">
                <div class="carousel-inner justify-content-center">
                    <div class="carousel-item-index" data-cidade="campina-grande">
                        <div class="card" style="width: 100%;">
                            <div class="image-container">
                                <img src="./src/img/capa-galpao-joao-firmino-obra-maximo-aldana-496x366.png" class="card-img-top" alt="...">
                                <p class="img-text-title">GALPÃO JOÃO FIRMINO</p>
                            </div>
                            <div class="card-body">
                                ...
                                <h4 class="card-text-two">Galpão João Firmino</h4>
                                <p class="card-content">1.880,00 m²</p>
                            </div>
                        </div>
                    </div>
                    <div class="carousel-item-index" data-cidade="campos-dos-goytacazes">
                        <div class="card" style="width: 100%;">
                            <div class="image-container">
                                <img src="./src/img/capa-Transportadora-Evelyn-Obra-de-Infraestrutura-Construtora-Maxcimo-Aldana-496x366.png" class="card-img-top" alt="...">
                                <p class="img-text-title" style="font-size: 25px;">TRANSPORTADORA EVELYN</p>
                            </div>
                            <div class="card-body">
                                <a class="link-card-title" href="">
                                    <h5 class="card-title">Saiba Mais <span class="material-symbols-outlined">arrow_forward_ios</span></h5>
                                </a>
                                <p class="card-text">SÃO CAETANO DO SUL (SP)</p>
                                <h4 class="card-text-two">Transportadora Evelyn</h4>
                                <p class="card-content">1.000,00 m²</p>
                            </div>
                        </div>
                    </div>
                    <div class="carousel-item-index" data-cidade="divinopolis">
                        <div class="card" style="width: 100%;">
                            <div class="image-container">
                                <img src="./src/img/capa-Galpao-Amparo-Obra-Maximo-Aldana-496x366.png" class="card-img-top" alt="...">
                                <p class="img-text-title">GALPÃO AMPARO</p>
                            </div>
                            <div class="card-body">
                                <a class="link-card-title" href="">
                                    <h5 class="card-title">Saiba Mais <span class="material-symbols-outlined">arrow_forward_ios</span></h5>
                                ...
                                <p class="card-text">SÃO BERNARDO DO CAMPO (SP)</p>
                                <h4 class="card-text-two">Galpão Amparo</h4>
                                <p class="card-content">600,00 m²</p>
                            </div>
                        </div>
                    </div>
                </div>
