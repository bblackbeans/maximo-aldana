<?php
/*
Template Name: Single Obras Saúde Construtora
*/
include('header.php'); ?>
    ...
    <div class="container-fluid">
        <div class="container-banner">
            <div class="container-title-banner-dna">
                <h1>Hospital <br>&ensp;&ensp;Unimed Sul Mineira</h1>
            </div>
        ...
        <div id="carouselExampleIndicators" class="carousel slide">
            ...
            <div class="carousel-inner">
                ...
                <div class="carousel-item">
                    <img src="./src/img/Banner-Somos-Maximo.png" class="d-block w-100" alt="">
                </div>
                <div class="carousel-item">
                    <img src="./src/img/banner-vaga.png" class="d-block w-100" alt="">
                </div>
            </div>
            ...
            <div class="container-one-detalhes">
                <div>
                    <div class="content-text-detalhes">
                        ...
                        <h2 class="valor-detalhe-obra-saude">22.787 m²</h2>
                    </div>
                    <hr>
                </div>
                <div>
                    <div class="content-text-detalhes">
                        ...
                        <h2 class="valor-detalhe-obra-saude">Março de 2025</h2>
                    </div>
                    <hr>
                </div>
                <div>
                    <div class="content-text-detalhes">
                        ...
                        <h2 class="valor-detalhe-obra-saude">EMED</h2>
                    </div>
                    <hr>
                </div>
            </div>
            <div class="container-one-detalhes">
                <div>
                    <div class="content-text-detalhes">
                        ...
                        <h2 class="valor-detalhe-obra-saude">Obra de Saúde</h2>
                    </div>
                    <hr>
                </div>
                <div>
                    <div class="content-text-detalhes">
                        ...
                        <h2 class="valor-detalhe-obra-saude">24 meses</h2>
                    </div>
                    <hr>
                </div>
                <div>
                    <div class="content-text-detalhes">
                        <h2 class="name-detalhe-obra-saude">Início da Obra</h2>
                        <h2 class="valor-detalhe-obra-saude">Março de 2023</h2>
                    </div>
                    <hr>
                </div>
            </div>
                    ...
                    <div class="carousel-item-index" data-cidade="pouso-alegre">
                        <div class="card" style="width: 100%;">
                            <div class="image-container">
                                ...
                                <p class="img-text-title" style="font-size: 30px !important;">HOSPITAL UNIMED SUL MINEIRA</p>
                            </div>
                            <div class="card-body">
                                ...
                                <p class="card-text">POUSO ALEGRE (MG)</p>
                                <h4 class="card-text-two">Hospital Unimed Sul Mineira</h4>
                                <p class="card-content">22.787 m²</p>
                            </div>
                        </div>
                    </div>
                    <div class="carousel-item-index" data-cidade="campina-grande">
                        <div class="card" style="width: 100%;">
                            <div class="image-container">
                                ...
                                <p class="img-text-title" style="font-size: 30px !important;">HOSPITAL UNIMED CAMPINA GRANDE</p>
                            </div>
                            <div class="card-body">
                                <a class="link-card-title" href="">
                                    <h5 class="card-title">Saiba Mais <span class="material-symbols-outlined">arrow_forward_ios</span></h5>
                                </a>
                                <p class="card-text">CAMPINA GRANDE (PB)</p>
                                <h4 class="card-text-two">Hospital Unimed Campina Grande</h4>
                                <p class="card-content">15.740 m²</p>
                            </div>
                        </div>
                    </div>
                    <div class="carousel-item-index" data-cidade="campos-dos-goytacazes">
                        <div class="card" style="width: 100%;">
                            <div class="image-container">
                                ...
                                <p class="img-text-title" style="font-size: 30px !important;">HOSPITAL NURSING CARE</p>
                            </div>
                            <div class="card-body">
                                <a class="link-card-title" href="">
                                    <h5 class="card-title">Saiba Mais <span class="material-symbols-outlined">arrow_forward_ios</span></h5>
                                </a>
                                <p class="card-text">CAMPOS DOS GOYTACAZES (RJ)</p>
                                <h4 class="card-text-two">Hospital <br> Nursing Care</h4>
                                <p class="card-content">6.447 m²</p>
                            </div>
                        </div>
                    </div>
                    <div class="carousel-item-index" data-cidade="divinopolis">
                        <div class="card" style="width: 100%;">
                            <div class="image-container">
                                ...
                                <p class="img-text-title" style="font-size: 30px !important;">HOSPITAL SÃO JOÃO DE DEUS</p>
                            </div>
                            <div class="card-body">
                                <a class="link-card-title" href="">
                                    <h5 class="card-title">Saiba Mais <span class="material-symbols-outlined">arrow_forward_ios</span></h5>
                                </a>
                                <p class="card-text">DIVINÓPOLIS (MG)</p>
                                <h4 class="card-text-two">Hospital São João de Deus</h4>
                                <p class="card-content">4.857 m</p>
                            </div>
                        </div>
                    </div>
                </div>
