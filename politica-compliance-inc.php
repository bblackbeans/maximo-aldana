<?php
/*
Template Name: Política de Compliance - Incorporadora
*/
    ...
    <div class="container-fluid">
        <div class="container-banner">
            <div class="container-banner-oportunidades__title">
                <h1>Política de<br> &ensp;&ensp; Compliance</h1>
            </div>
        </div>
    </div>
</section>
...
<section class="container" id="somos-maximo" style="margin-bottom: 2rem !important;">
    ...
    <div class="container-content-oportunidades">
        <h1 style="margin-bottom: 2rem;">Política de Compliance da Máximo Aldana</h1>
        <h2>Compromisso com a Excelência e Ética</h2>
        <h2 style="margin-bottom: 2rem;">Nossas Práticas de Compliance Garantem Negócios Justus e Transparentes</h2>
        <p>Clique no botão abaixo para baixar a política de compliance da Máximo Aldana</p>
        <button class="btn-baixar-compliance-inc">BAIXAR POLÍTICA DE COMPLIANCE</button>
    </div>

    <div class="container-btns-denuncia-inc">
        <button>SOBRE A MAXIMO ALDANA <i class="fa-solid fa-arrow-right"></i></button>
        <button>CANAL DE DENÚNCIAS <i class="fa-solid fa-arrow-right"></i></button>
    </div>
</section>
