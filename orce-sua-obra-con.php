<?php
/*
Template Name: Orce sua obra - Construtora
*/
include('header.php'); ?>
    ...
    <div class="container-fluid">
        <div class="container-banner">
            <div class="container-title-banner-dna">
                <h1>Orce sua <br>&ensp;&ensp;Obra Conosco </h1>
            </div>
...
<section id="form-orce-sua-obra">
    <div class="container container-form-orce-sua-obra-con containerform-seu-terreno">
        <div class="content-text-orce-sua-obra-con">
            ...
            <h2>Construa com Máximo Aldana</h2>
            <p>Agilidade, experiência e comprometimento em nossa entrega. Somos especialistas em <br> obras de grande porte para os segmentos de Hospitais, Corporativo, Educação, Prediais <br> Comerciais e Residenciais.</p>
            <p>Preencha e envie o formulário ao lado e em breve entraremos em contato com você.</p>
            <div class="container-btn-dna-con" style="justify-content: flex-start;">
                <button style="padding-left: 2rem;">SOBRE A MAXIMO ALDANA <i class="fa-solid fa-arrow-right"></i></button>
            </div>
        </div>
