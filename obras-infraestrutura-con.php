...
<section id="para-sua-fase">
    <div class="container-fluid px-5">
        <div class="container-title">
            <h3 style="font-size: 43px;" class="container-title__title">Conheça todas as obras de infraestrutura</h3>
            <h3 style="font-size: 43px;" class="container-title__title">construídas pela Maximo Aldana.</h3>
        </div>
            ...
            <div class="carousel">
                <div class="carousel-inner">
                    <div class="carousel-item-index" data-cidade="pouso-alegre">
                        <div class="card" style="width: 100%;">
                            <div class="image-container">
                                <img src="./src/img/capa-Aeroporto-de-Aripuanã-Obra-Maximo-Aldana-496x366.png" class="card-img-top" alt="...">
                                <p class="img-text-title">AEROPORTO DE ARIPUANÃ</p>
                            </div>
                            <div class="card-body">
                                ...
                                <p class="card-text">ARIPUANÃ (MT)</p>
                                <h4 class="card-text-two">Aeroporto De Aripuanã</h4>
                                <p class="card-content">33.333 m²</p>
                            </div>
                        </div>
                    </div>
                    <div class="carousel-item-index" data-cidade="pouso-alegre">
                    ...
                    <div class="carousel-item-index" data-cidade="campos-dos-goytacazes">
                        <div class="card" style="width: 100%;">
                            <div class="image-container">
                                <img src="./src/img/capa-galpao-joao-firmino-obra-maximo-aldana-496x366.png" alt="...">
                    ...
                    <div class="carousel-item-index" data-cidade="divinopolis">
                        <div class="card" style="width: 100%;">
                            <div class="image-container">
                                ...
                                <p class="img-text-title">TRANSPORTADORA EVELYN</p>
                            </div>
                            <div class="card-body">
                                <a class="link-card-title" href="">
                                    <h5 class="card-title">Saiba Mais <span class="material-symbols-outlined">arrow_forward_ios</span></h5>
