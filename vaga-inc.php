<?php
/*
Template Name: Vaga - Incorporadora
*/
    ...
    <div class="container-fluid">
        <div class="container-banner">
            <div class="container-banner-oportunidades__title">
                <h1>Conheça nossas <br> &ensp;&ensp; Oportunidades </h1>
            </div>
...
<section class="container" id="somos-maximo" style="margin-bottom: 2rem !important;">
    ...
    <div class="container-content-oportunidades">
        ...
        <h2>Informação destaque 1 l Informação destaque 2</h2>
        <button class="btn-status-vaga">Status da vaga: Aberta</button>
    </div>
</section>
...
<section id="content-vaga">
    <div class="container" style="max-width: 90%;">
        ...
        <div class="container-btns-vaga">
            <button>JUNTE-SE AO NOSSO TIME <i class="fa-solid fa-arrow-right"></i></button>
            <button>JUNTE-SE AO NOSSO TIME <i class="fa-solid fa-arrow-right"></i></button>
            <button>JUNTE-SE AO NOSSO TIME <i class="fa-solid fa-arrow-right"></i></button>
        </div>
    </div>
