<?php
/*
Template Name: Governança - Incorporadora
*/
include('header-vaga-inc.php'); ?>

<section id="banner" class="py-5">
    <div class="container-fluid">
        <div class="container-banner">
            <div class="container-banner-oportunidades__title">
                <h1>Governança<br> &ensp;&ensp; Corporativa </h1>
            </div>
...
<section id="content-vaga">
    <div class="container" style="max-width: 90%;">
        <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.
            ...
            cillum dolore eu fugiat nulla pariatur. Excepteur sint occaecat cpidatat non proident, sunt in culpa qui officia deserunt
            ...
            reprehenderit in voluptate velit esse cillum dolore eu fugiat nulla pariatur. Excepteur sint occaecat cpidatat non proident,
            sunt in culpa qui officia deserunt mollit anim id est laborum. Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed
            ...
            in reprehenderit in voluptate velit esse cillum dolore eu fugiat nulla pariatur. Excepteur sint occaecat cpidatat non proident,
            ...
            Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut
            enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat. Duis aute irure dolor in
            reprehenderit in voluptate velit esse cillum dolore eu fugiat nulla pariatur. Excepteur sint occaecat cpidatat non proident, sunt
            ...
            dolore eu fugiat nulla pariatur. Excepteur sint occaecat cpidatat non proident,.</p>

    </div>
</section>

<section id="compilance">
    <h1>Compliance</h1>
    <button>POLÍTICA DE COMPILANCE MAXIMO ALDANA <i class="fa-solid fa-arrow-right"></i></button>
</section>

<section id="canal-denuncia">
    <h1>Canal de Denúncia</h1>
    <button>CANAL DE DENÚNCIA MAXIMO ALDANA <i class="fa-solid fa-arrow-right"></i></button>
</section>
