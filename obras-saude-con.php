<?php
/*
Template Name: Obras da Saúde Construtora
*/
include('header.php'); ?>
...
<section id="para-sua-fase">
    <div class="container-fluid px-5">
        <div class="container-title">
            <h3 class="container-title__title">Conheça todas as obras de saúde</h3>
        ...
        <div class="container-fase">
            ...
            <div class="container-fase__button">
                <button class="btn-filtrar" style="background-color: #18354f; margin-bottom: 4rem;" id="filterBtn">FILTRAR &ensp; <svg xmlns="http://www.w3.org/2000/svg" width="25" height="25" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="ai ai-SettingsHorizontal">
    ...
    <div class="container-fluid p-0">
        <div class="container-form">
            <div class="container-form__img">
                <img src="./src/img/saude cta.png" alt="">
            </div>
