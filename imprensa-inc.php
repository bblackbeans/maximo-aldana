<?php
/*
Template Name: Imprensa - Incorporadora
*/
    ...
    <div class="container-fluid">
        <div class="container-banner">
            <div class="container-banner-oportunidades__title">
                <h1>Maximo<br> &ensp;&ensp; na Mídia</h1>
            </div>
        </div>
    </div>
</section>
...
<section id="blog-title-inc">
    <div class="container container-title-blog-maximo">
        <h1>Maximo Aldana na Mídia</h1>
        <h2>Veja como estamos moldando o futuro do Mercado Imobiliário</h2>
        <p>Confira todas as matérias que a Maximo Aldana já colaborou.</p>
    </div>
</section>
...
<section id="blog-home" class="pb-5">
    <div class="container-fluid px-2">
        ...
        <div class="container-button-todos">
            <button class="ver-todos-button bg-acquagreen" onclick="toggleCardBlog()">VER MAIS</button>
        </div>
        <div class="container-btns-denuncia-inc" style="margin: 2rem 0 0rem;">
            <button style="padding-left: 4rem;">ACESSORIA DE IMPRENSA <i class="fa-solid fa-arrow-right"></i></button>
        </div>
    </div>
</section>
