<?php
/*
Template Name: Política de Privacidade - Incorporadora
*/
    ...
    <div class="container-fluid">
        <div class="container-banner">
            <div class="container-banner-oportunidades__title">
                <h1>Política de<br> &ensp;&ensp; Privacidade</h1>
            </div>
        </div>
    </div>
</section>
...
<section class="container" id="somos-maximo" style="margin-bottom: 2rem !important;">
    ...
    <div class="container-btns-denuncia-inc">
        <button>POLÍTICA DE PRIVACIDADE <i class="fa-solid fa-arrow-right"></i></button>
        <button>POLÍTICA DE COOKIES <i class="fa-solid fa-arrow-right"></i></button>
        <button>TERMOS DE USO <i class="fa-solid fa-arrow-right"></i></button>
    </div>
</section>

<section id="content-politica-inc">
    <div class="container">
        <div class="text-politica-inc">
            <h1>Política de Privacidade</h1>
            <p>Com mais de 25 anos de mercado a Maximo Aldana traduz diariamente seu DNA em cada projeto que realiza e se encontra hoje no seleto grupo das 100 maiores Construtoras do Brasil segundo Ranking INTEC (Informações Técnicas da Construção).</p>
            <p> Atuando no segmento de engenharia e construção civil desde a fundação, nos destacamos pela cultura proativa, sempre com sangue no olho para direcionar todos os nossos esforços para encantar nossos clientes. Com nossa Gestão Inteligente e nosso Senso de Urgência, nos tornamos referência nos segmentos de obras prediais, hospitalares, corporativas e retrofits.</p>
            <p>O setor imobiliário</p>
            <p>Em 2012, iniciamos a unidade de negócio focada no desenvolvimento imobiliário das regiões do Grande ABC, São Paulo e Litoral, construindo e incorporando nossos próprios empreendimentos com foco em entregar excelência em cada detalhe de nossos produtos. </p>
            <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat. Duis aute irure dolor in reprehenderit in voluptate velit esse cillum dolore eu fugiat nulla pariatur. Excepteur sint occaecat cupidatat non proident, sunt in culpa qui officia deserunt mollit anim id est laborum. Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat. Duis aute irure dolor in reprehenderit in voluptate velit esse cillum dolore eu fugiat nulla pariatur. Excepteur sint occaecat cpidatat non proident, sunt in culpa qui officia deserunt mollit anim id est laborum.</p>
        </div>
        <div class="text-politica-inc">
        ...
        <div class="termos-politica-inc">
            <h1>Termos de Uso</h1>
        </div>
        <div class="container-btns-denuncia-inc">
            <button>VER TERMOS DE USO MAXIMO ALDANA <i class="fa-solid fa-arrow-right"></i></button>
        </div>
    </div>
</section>
