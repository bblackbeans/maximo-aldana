<?php
/*
Template Name: Nossas Oportunidades - Inc
*/
include('header-oportunidades-inc.php'); ?>
...
<section class="container" id="somos-maximo">
    ...
    <div class="container-content-oportunidades">
        ...
        <h2>Venha fazer parte do nosso time! Confira as oportunidades e candidata-se</h2>
    </div>
</section>

<section id="vagas">
    <div class="container container-filtrar-opotunidades">
        <p>Encontre sua vaga</p>
        <button class="bt-oportunidades-filtrar" id="filterBtn">FILTRAR &ensp; <svg xmlns="http://www.w3.org/2000/svg" width="25" height="25" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="ai ai-SettingsHorizontal">
        ...
        <div class="container-nao-a-vagas">
            <h2>Não há vagas no momento!</h2>
            <p class="paragrafo-nao-a-vagas">Responda o formulário "Junte-se ao nosso time", quando tivermos vagas disponíveis do seu perfil, entraremos em contato</p>
...
<section id="oportunidades-somos-maximos">
