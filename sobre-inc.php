<?php
/*
Template Name: Sobre Incorporadora
*/
include('header-sobre-inc.php'); ?>

<section id="banner" class="py-5">
    <div class="container">
        <div class="container-banner">
            <div class="container-banner-sobre__title">
                <h1>Somos <br> &ensp;&ensp; Maximo </h1>
            </div>
...
<section class="container" id="somos-maximo">
    ...
    <div class="container-content-somos-maximo">
        <h1>#Somos<span>Maximo</span></h1>
...
<section id="proposito">
    <div class="container container-content-text">
        <h1>Propósito, Visão e Valores.</h1>
        <div class="container-content-proposito">
            <h4>Nosso</h4>
            <h1>Propósito</h1>
            <p>Transformar o Brasil através da construção civil com processos sustentáveis e inovadores.</p>
        </div>
        <div class="container-content-visao">
            <h4>Nossa</h4>
            <h1>Visão</h1>
            <p>Ser referência no mercado da construção residencial, comercial e hospitalar em todo o território nacional.</p>
            <p>Construir oportunidades de investimentos seguros em imóveis, garantindo retorno aos investidores e melhorando a qualidade de vida dos clientes.</p>
        </div>
    </div>
</section>
